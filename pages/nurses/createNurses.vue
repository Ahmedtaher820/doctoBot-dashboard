...
<template>
  <div class="bg-white py-3 px-6 rounded-2xl">
    <div class="header">
      ...
      <p class="text-sm text-zinc-500">Add new nurses with name, phone, email, password, city</p>
    </div>
    <div class="grid grid-cols-2 md:mt-16 mt-8 place-items-start">
      ...
      <form @submit.prevent="submitForm" class="w-2/3 flex flex-col gap-6">
        ...
        <FormBaseButton type="submit" custome-bg="bg-green-500" class="text-white w-1/4 ms-auto mt-6 rounded-none">Create
        </FormBaseButton>
      </form>
    </div>
  </div>
